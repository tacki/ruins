 ...
 * Namespaces
 */
namespace Ruins\Modules\Survey\Manager;
use DateTime;
use Doctrine\DBAL\Types\Type;
use Ruins\Main\Entities\Character;
use Ruins\Modules\Survey\Entities\Poll;
use Ruins\Modules\Survey\Entities\Vote;
use Ruins\Modules\Survey\Entities\Answer;
...
class SurveyManager
{
     ...
     * @param int $id
     * @return Ruins\Modules\Survey\Entities\Poll
     */
    ...
    * @param int $id
    * @return Ruins\Modules\Survey\Entities\Answer
    */
    public static function getAnswer($id)
    {
        $em = Registry::getEntityManager();

        return $em->find("Module:Survey\Entities\Answer", $id);
    }
    ...
    public static function getAllPolls($active=true)
    {
        ...
        $qb ->select("poll")
            ->from("Module:Survey\Entities\Poll", "poll");
        if ($active) {
     ...
     * @param Ruins\Modules\Survey\Entities\Poll $poll
     * @return array
     */
     ...
     * @param Ruins\Modules\Survey\Entities\Answer $answer
    ...
    */
    public static function deletePoll($pollId)
    {
        ...
        $poll = $em->find("Module:Survey\Entities\Poll", $pollId);
    ...
    */
    ...
    public static function hasVoted(Character $character, Poll $poll)
    {
        ...
        $qb ->select("vote")
            ->from("Module:Survey\Entities\Vote", "vote")
    ...
    public static function removeVote($voteID)
    {
        ...
        $result = $em->find("Module:Survey\Entities\Vote", "vote", $voteID);
