...
$popup->nav->addLink("Benutzer", "popup/popup/settings/user")
           ->addLink("Charakter", "popup/popup/settings/char")
           ->addLink("Sonstiges", "popup/popup/settings/other");
...
switch ($_GET['op']) {
    ...
    default:
    case "user":
        $popup->getForm("settings")->head("settingsform", "popup/popup/settings/change");
