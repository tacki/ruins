...
$popup->nav->addLink("Verfassen", "popup/popup/messenger/create")
           ->addLink("Posteingang", "popup/popup/messenger/inbox")
           ->addLink("Postausgang", "popup/popup/messenger/outbox");
...
switch ($_GET['op']) {
    ...
    case "create":
        ...
        $snippet->assign("target", "popup/popup/messenger/send");
    ...
    case "reply":
        $snippet = $popup->createTemplateSnippet();
        $snippet->assign("target", "popup/popup/messenger/send&reply=1");
    ...
    case "inbox":
        ...
        $popup->getForm("delete")->head("deleteform", "popup/popup/messenger/delete");
        ...
        foreach ($messagelist as $message) {
            ...
            $showmessage['sender']		= "<a href='?popup/popup/messenger/read&messageid=".$message->id."'>".$message->sender->name."</a>";
            $showmessage['subject'] 	= "<a href='?popup/popup/messenger/read&messageid=".$message->id."'>".$message->data->subject."</a>";
    ...
    case "read":
        if (isset($_GET['messageid'])) {
            ...
            $snippet = $popup->createTemplateSnippet();
            $snippet->assign("target", "popup/popup/messenger/reply&replyto=".$message->id);
    ...
    case "delete":
        if (isset($_POST['chooser'])) {
            ...
            $popup->addForm("delete");
            $popup->getForm("delete")->head("deleteform", "popup/popup/messenger/delete&ask=yes");
    ...
    case "outbox":
        ...
        foreach ($messagelist as $message) {
            $showmessage = array();
            $showmessage['receiver']	= "<a href='?popup/popup/messenger/read&messageid=".$message->id."'>".$message->receiver->displayname."</a>";
            $showmessage['subject'] 	= "<a href='?popup/popup/messenger/read&messageid=".$message->id."'>".$message->data->subject."</a>";
            $showmessage['date']		= $message->date->format("H:i:s d.m.y");
