...
class Travel {
    ...
    * @param Ruins\Main\Entities\Site $current_location the location which should be checked
    * @return array Array of Ruins\Main\Entities\Site
    */
    ...
    /**
     * return the available connections from the current location
     * @param Ruins\Main\Entities\Waypoint $current_location the location which should be checked
     * @return array Array of Ruins\Main\Entities\Waypoint
     */
