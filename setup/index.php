...
switch ($_GET['step']) {
    ...
    default:
        ...
        echo "<form action='index.php?step=1' method='post'>
    ...
    case 1:
        ...
        $writeaccess["Configuration Directory"] = BASEDIR."/app/config";
        $writeaccess["Temp Folder"]				= BASEDIR."/app/tmp";
        ...
        foreach ($writeaccess as $description => $dirname) {
            ...
            if (!file_exists($dirname) && is_writable(BASEDIR)) {
            ...
            if (is_writable($dirname)) {
                ...
                echo "<form action='index.php?step=" . ($_GET['step']) .  "' method='post'>
        ...
        // dirconfig-file
        $createdirs['Dummy Dir'] 	            = BASEDIR."/app/tmp/dummy";
        $createdirs['Doctrine Proxy Dir']       = BASEDIR."/app/tmp/proxies";
        $createdirs['Smarty Temp Base Dir'] 	= BASEDIR."/app/tmp/smarty";
        $createdirs['Smarty Temp Cache Dir']	= BASEDIR."/app/tmp/smarty/cache";
        $createdirs['Smarty Temp Compile Dir']	= BASEDIR."/app/tmp/smarty/templates_c";
        $createdirs['OpenID Temp Base Dir']		= BASEDIR."/app/tmp/openid";
        ...
        $conffiles['dirconfig']['path']			= BASEDIR."/app/config/dirconf.cfg.php";
        ...
        // $conffiles['configname']['path']		= BASEDIR."/app/config/configname.cfg.php";
        ...
        foreach ($conffiles as $confname=>$conffile) {
            ...
            if (!file_exists($conffile['path']) || (isset($_GET['overwrite']) && $_GET['overwrite'] == $confname)) {
                ...
                echo "<form action='index.php?step=" . ($_GET['step']) . "&overwrite=" . $confname . "' method='post'>
        ...
        // Do the voodoo
        $systemConfig = new Ruins\Common\Controller\Config;
        foreach ($extensions as $description => $extension) {
            echo "<div class='checkfor'>" . $description . " ... </div>";
        ...
        echo "<form action='index.php?step=" . ($_GET['step']+1) .  "' method='post'>
    ...
    case 2:
        ...
        if (file_exists(BASEDIR."/app/config/dbconnect.cfg.php")) {
        ...
        if ($needDBinfo) {
            echo "
                    <form action='index.php?step=" . ($_GET['step']) .  "&updateDBinfo' method='post'>
                    <table border='0'>
                    <tr>
                        <td>Databasetype:</td>
    ...
    case 3:
        ...
        if (isset($_GET['import'])) {
            ...
            try {
                ...
                echo "<form action='index.php?step=" . ($_GET['step']) . "&import=true&force=true' method='post'>
        ...
        if ($oldtablesfound) {
            ...
            echo "<form action='index.php?step=" . ($_GET['step']) . "&import=true' method='post'>
