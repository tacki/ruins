 ...
 * @version SVN: $Id: money.mod.php 326 2011-04-19 20:19:34Z tacki $
 * @package Ruins
 */
...
class Money extends Manager
{
    ...
    {
        return "Extend the Money Property to handle different currencies";
    }

    /**
     * Manager Module setter
     * @see includes/interfaces/Manager#setManagedValue()
     * $param in $property unsorted Money value
     */
     ...
     * @see includes/interfaces/Manager#getManagedValue()
    ...
    public function receive($amount, $currency="copper")
    {
        if ($amount instanceof Money) {
            ...
            if ($result && $this->parent instanceof Character) {
                $this->parent->debuglog->add("Receive "
                                    . $amount->detailed("gold") . " Gold, "
                                    . $amount->detailed("silver") . " Silver and "
                                    . $amount->detailed("copper") . " Copper"
                                    , "veryverbose");
